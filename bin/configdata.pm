...
our %config = (
  ...
  builddir => ".",
  cflags => [  ],
  conf_files => [ "C:\\cpython\\externals\\openssl-1.1.1l\\Configurations\\00-base-templates.conf", "C:\\cpython\\externals\\openssl-1.1.1l\\Configurations\\10-main.conf", "C:\\cpython\\externals\\openssl-1.1.1l\\Configurations\\50-masm.conf" ],
  cppflags => [  ],
  cxxflags => [  ],
  defines => [ "NDEBUG" ],
